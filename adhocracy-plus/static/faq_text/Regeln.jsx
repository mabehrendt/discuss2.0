    ...
    return (
        <div>
            ...
            <ul>
                ...
                <li>Bei schweren oder wiederholten Verstößen gegen die Netiquette oder der missbräuchlichen Nutzung anderer Funktionen können einzelne Nutzer:innen gesperrt werden.</li>
            </ul>
        </div>
    );
}

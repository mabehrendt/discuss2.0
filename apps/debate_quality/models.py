...
class AIQualitySubjectQuerySet(query.CommentableQuerySet):
    pass


class AIQualitySubject(module_models.Item):
    ...
    objects = AIQualitySubjectQuerySet.as_manager()
    ...
    def get_absolute_url(self):
        return reverse(
            'a4_candy_debate_quality:aiqualitysubject-detail',
            kwargs=dict(

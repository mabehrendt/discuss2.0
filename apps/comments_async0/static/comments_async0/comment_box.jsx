         ...
         <div>
           <div className="buttonBox">
             ...
             <Badge color="primary" badgeContent="Feed" invisible={false}>
               <button className="feedButton" onClick={() => {const currentPath = encodeURIComponent(window.location.pathname); console.log(currentPath); window.location.href = `/userdashboard/overview/?from=${currentPath}`;}}><img className="sprechblase-button" src={require("../../../../adhocracy-plus/static/stance_icons/rss-feed.png")} alt="Feed" /></button>
             </Badge>
           </div>

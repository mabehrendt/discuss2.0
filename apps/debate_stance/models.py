...
class AIStanceSubjectQuerySet(query.CommentableQuerySet):
    pass


class AIStanceSubject(module_models.Item):
    ...
    stances = GenericRelation(models_stance.Stance, related_query_name="aistancesubject", object_id_field='object_id')

    comments = GenericRelation(comment_models.Comment,
                               related_query_name='aistancesubject',
                               object_id_field='object_pk')

    objects = AIStanceSubjectQuerySet.as_manager()
    ...
    def get_absolute_url(self):
        return reverse(
            'a4_candy_debate_stance:aistancesubject-detail',
            kwargs=dict(

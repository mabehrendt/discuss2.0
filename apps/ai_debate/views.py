...
class AISubjectDetailView(idea_views.AbstractIdeaDetailView):
    model = models.AISubject
    permission_required = 'a4_candy_ai_debate.view_aisubject'
...
class AISubjectListDashboardView(ProjectMixin,
    ...
    model = models.AISubject
    template_name = 'a4_candy_ai_debate/aisubject_dashboard_list.html'
...
class AISubjectCreateView(mixins.DashboardBaseMixin,
    ...
    permission_required = 'a4_candy_ai_debate.add_aisubject'
    template_name = 'a4_candy_ai_debate/aisubject_create_form.html'
...
class AISubjectUpdateView(mixins.DashboardBaseMixin,
    ...
    model = models.AISubject
    form_class = forms.AISubjectForm
    permission_required = 'a4_candy_ai_debate.change_aisubject'
    template_name = 'a4_candy_ai_debate/aisubject_update_form.html'
...
class AISubjectDeleteView(mixins.DashboardBaseMixin,
    ...
    permission_required = 'a4_candy_ai_debate.change_aisubject'
    template_name = 'a4_candy_ai_debate/aisubject_confirm_delete.html'

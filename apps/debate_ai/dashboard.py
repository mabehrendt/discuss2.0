...
class AISubjectEditComponent(DashboardComponent):
    ...
    def is_effective(self, module):
        ...
        return module_app == 'a4_candy_debate_ai'
...
class AIExportSubjectComponent(DashboardComponent):
    ...
    def is_effective(self, module):
        module_app = module.phases[0].content().app
        return (module_app == 'a4_candy_debate_ai' and
...
components.register_module(AIExportSubjectComponent())

...
class AISubjectDetailView(idea_views.AbstractIdeaDetailView):
    model = models.AISubject
    permission_required = 'a4_candy_debate_ai.view_subject'
...
class AISubjectListDashboardView(ProjectMixin,
    ...
    model = models.AISubject
    template_name = 'a4_candy_debate_ai/subject_dashboard_list.html'
...
class AISubjectCreateView(mixins.DashboardBaseMixin,
    ...
    permission_required = 'a4_candy_debate_ai.add_subject'
    template_name = 'a4_candy_debate_ai/subject_create_form.html'
...
class AISubjectUpdateView(mixins.DashboardBaseMixin,
    ...
    model = models.AISubject
    form_class = forms.AISubjectForm
    permission_required = 'a4_candy_debate_ai.change_subject'
    template_name = 'a4_candy_debate_ai/subject_update_form.html'
...
class AISubjectDeleteView(mixins.DashboardBaseMixin,
    ...
    permission_required = 'a4_candy_debate_ai.change_subject'
    template_name = 'a4_candy_debate_ai/subject_confirm_delete.html'

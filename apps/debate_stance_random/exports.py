...
class StanceRandomSubjectExportView(PermissionRequiredMixin,
...
class StanceRandomSubjectCommentExportView(PermissionRequiredMixin,
                               mixins.ItemExportWithLinkMixin,
                               mixins.ExportModelFieldsMixin,
    ...
    def get_queryset(self):
        comments = (Comment.objects.filter(stancerandomsubject__module=self.module) |
                    Comment.objects.filter(
                    parent_comment__stancerandomsubject__module=self.module)).annotate(

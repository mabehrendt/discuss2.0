...
class StanceRandomSubjectQuerySet(query.CommentableQuerySet):
    pass


class StanceRandomSubject(module_models.Item):
    ...
    stances = GenericRelation(models_stance.Stance, related_query_name="stancerandomsubject", object_id_field='object_id')

    comments = GenericRelation(comment_models.Comment,
                               related_query_name='stancerandomsubject',
                               object_id_field='object_pk')

    objects = StanceRandomSubjectQuerySet.as_manager()
    ...
    def get_absolute_url(self):
        return reverse(
            'a4_candy_debate_stance_random:stancerandomsubject-detail',
            kwargs=dict(

...
class QualityRandomSubjectQuerySet(query.CommentableQuerySet):
    pass


class QualityRandomSubject(module_models.Item):
    ...
    def get_absolute_url(self):
        return reverse(
            'a4_candy_debate_quality_random:qualityrandomsubject-detail',
            kwargs=dict(

...
class QualityRandomSubjectExportView(PermissionRequiredMixin,
...
class QualityRandomSubjectCommentExportView(PermissionRequiredMixin,
                               mixins.ItemExportWithLinkMixin,
                               mixins.ExportModelFieldsMixin,
    ...
    def get_queryset(self):
        comments = (Comment.objects.filter(qualityrandomsubject__module=self.module) |
                    ...
                    parent_comment__qualityrandomsubject__module=self.module)).annotate(

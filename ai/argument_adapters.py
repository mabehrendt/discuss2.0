...
task2identifier = {"anrede": adapters_path+"address",
                   "begründung": adapters_path+"justification",
                   "beleidigung": adapters_path+"insult",
                   "bezugform": adapters_path+"refformat",
                   "bezuginhalt": adapters_path+"refcontents",
                   "bezugmedium": adapters_path+"refmedium",
                   "bezugnutzer": adapters_path+"refusers",
                   "bezugpersönlich": adapters_path+"refpersonal",
                   "diskriminierung": adapters_path+"discrimination",
                   "frage": adapters_path+"question",
                   "lösungsvorschlag": adapters_path+"solproposal",
                   "meinung": adapters_path+"opinion",
                   "respekt": adapters_path+"respect",
                   "sarkasmus": adapters_path+"sarcasm",
                   "schreien": adapters_path+"screaming",
                   "storytelling": adapters_path+"storytelling",
                   "tatsache": adapters_path+"fact",
                   "themenbezug": adapters_path+"relevance",
                   "vulgär": adapters_path+"vulgar",
                   "zusatzwissen": adapters_path+"addknowledge"}
